...
print("\n")
print("Data evaluation in progress...")
...
scores.to_csv(f"/work/mbouthil/MMATH-CM-Research-Project/RAG/results/eval_results_{model_name}.csv", index=False)