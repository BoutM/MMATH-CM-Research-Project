...
You will be provided passage(s). Your task is to provide hypothetical questions which are answered by the contents of the pasaage(s). 

Proivide your questions:
'''
